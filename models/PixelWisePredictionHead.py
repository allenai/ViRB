...
class PixelWisePredictionHead(nn.Module):
    ...
    def __init__(self, output_size):
        ...
        self.up2 = upshuffle(258, 256, 2, kernel_size=3, stride=1, padding=1)
        self.up3 = upshuffle(258, 256, 2, kernel_size=3, stride=1, padding=1)
        self.up4 = upshuffle(258, 64, 2, kernel_size=3, stride=1, padding=1)
